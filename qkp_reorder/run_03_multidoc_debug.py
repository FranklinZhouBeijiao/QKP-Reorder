...
DATA_PATH = PROJECT_ROOT / "data" / "stage3" / "stage3_multidoc_debug.json"
RESULT_DIR = PROJECT_ROOT / "results" / "stage3"
RESULT_PATH = RESULT_DIR / "stage3_debug_results.csv"
...
def make_base_row(
    ...
    """Create a row skeleton with the stable stage-3 CSV fields."""
    return {
...
def generate_answer_with_empty_retry(prompt: str) -> Dict[str, Any]:
    """Generate an answer, retrying once with a larger budget if content is empty."""
...
def run_one_method(
    ...
    """Run compression, generation, and evaluation for one sample-method pair."""
...
def main() -> None:
    ...
    print("\n" + "#" * 100)
    print(f"Saved stage 3 results to: {RESULT_PATH}")
