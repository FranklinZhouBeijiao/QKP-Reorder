...
DATA_PATH = PROJECT_ROOT / "data" / "stage6" / "processed" / "nq_multidoc_100.json"
RESULT_DIR = PROJECT_ROOT / "results" / "stage6"
RESULT_PATH = RESULT_DIR / "exp1_nq_100_results.csv"
...
def get_max_samples_to_run() -> int | None:
    """Read optional smoke-test sample limit from STAGE6_MAX_SAMPLES."""
...
def call_generate_answer_with_retry(prompt: str) -> Dict[str, Any]:
    """Generate an answer and retry once if final content is empty."""
...
def main() -> None:
    ...
    print("\n" + "#" * 100)
    print("Stage 6 NQ-100 experiment finished.")
